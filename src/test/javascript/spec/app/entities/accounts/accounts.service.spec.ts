    ...
    describe('Accounts Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/accounts';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Accounts', () => {
                service.create(new Accounts(null)).subscribe(received => {
            ...
            it('should update a Accounts', () => {
                service.update(new Accounts(123)).subscribe(received => {
